const translations = {
    ...
    he: {
        ...
        "danger-subtitle": "האיומים הדיגיטליים אינם עוד רק וירוסים חולפים, אלא הפכו למערכות הרסניות ומאורגנות המכוונות נגד תשתיות מידע קריטיות.",
        "danger-c1-title": "תוכנות כופר מתקדמות (Advanced Ransomware)",
        "danger-c1-desc": "תוכנות כופר מודרניות מסתמכות על אסטרטגיית 'סחיטה כפולה'. הן מדליפות נתונים רגישים תחילה ואז מצפינות אותם מקומית באמצעות אלגוריתמים היברידיים מורכבים כגון RSA-2048 ו-AES-256.",
        "danger-c2-title": "הנדסה חברתית וזיוף עמוק (Deepfakes)",
        "danger-c2-desc": "פישינג מסורתי התפתח לפישינג ממוקד (Spear Phishing) המבוסס על איסוף נתוני מודיעין ממקורות גלויים (OSINT) על הקורבן, בשילוב טכנולוגיות מתקדמות של זיוף עמוק קולי וחזותי.",

        "cyber-title": "הנדסת הגנת סייבר ומדיניות אבטחה",
        "cyber-subtitle": "אבטחת סייבר אינה מוצר מדף לרכישה, אלא מדע אינטגרטיבי המשלב טכנולוגיה חדשנית, מדיניות קפדנית ומודעות אנושית.",
        "cyber-c1-title": "ארכיטקטורת משולש ה-CIA",
        "cyber-c1-desc": "כל הנדסת האבטחה מתרכזת סביב שלושה עמודי תווך מרכזיים: סודיות (Confidentiality) למניעת גישה לא מורשית, שלמות (Integrity) למניעת שינויים לא מורשים, וזמינות המידע (Availability).",
        "cyber-c2-title": "מערכות גילוי ותגובה (EDR & SIEM)",
        "cyber-c2-desc": "מרכזי פעולות אבטחה (SOC) ממנפים כיום בינה מלאכותית לניתוח יומני אירועים בזמן אמת, מה שמאפשר חיזוי, זיהוי ונטרול של מתקפות יום אפס (Zero-Day) שאינן מוכרות מראש.",

        "systems-title": "הנדסה וניהול של מערכות מידע ארגוניות",
        "systems-subtitle": "עמוד השדרה הטכנולוגי המנהל את נכסי הידע של הארגון וממיר נתונים גולמיים מסיביים לתובנות ולהחלטות אסטרטגיות.",
        "systems-c1-title": "ששת הרכיבים המבניים של מערכות מידע",
        "systems-c1-desc": "מערכת מודרנית משלבת שישה אלמנטים חיוניים הפועלים בסנכרון מלא: חומרה (Hardware), תוכנה (Software), נתונים (Data), רשתות תקשורת (Networks), נהלים קפדניים (Procedures) ואנשים מוסמכים.",
        "systems-c2-title": "מחשוב ענן והנדסת ביג דאטה",
        "systems-c2-desc": "מעבר לסביבות ענן היברידיות (Hybrid Cloud) מעניק לארגונים גמישות דינמית עצומה בעיבוד ותיעוד של זרמי נתוני עתק מסיביים באמצעות מחסני נתונים (Data Warehouses) מותאמים.",

        "protection-title": "אסטרטגיות הגנת נתונים וביצור זהות דיגיטלית",
        "protection-subtitle": "כיצד להגן על עצמך, על החשבונות האישיים ועל הנכסים הדיגיטליים שלך מפני פריצות מתוחכמות באמצעות תקני אבטחה אישיים וארגוניים.",
        "protection-c1-title": "ניהול זהויות ואימות רב-גורמי (IAM & MFA)",
        "protection-c1-desc": "סיסמאות מסורתיות הן קו הגנה שקרס מזמן. אבטחה מודרנית מסתמכת על מנגנוני אימות רב-גורמי (MFA), המקשרים את הגישה למאפיינים ביומטריים או למפתחות אבטחה פיזיים.",
        "protection-c2-title": "הצפנה מקצה לקצה ומדיניות גיבוי",
        "protection-c2-desc": "אכיפת הצפנת נתונים במנוחה (At Rest) ובתנועה (In Transit), בשילוב אסטרטגיית גיבוי קפדנית במודל 3-2-1 על גבי אמצעי אחסון לא מקוונים ומבודדים לחלוטין מהרשת.",
        ...
        "stories-c2-desc": "בשנת 2017, מגפת תוכנת כופר עולמית ניצלה את פגיעות EternalBlue, והצפינה מאות אלפי מחשבים ומערכות תוך שעות ספורות, דבר שגרם לשיתוק בתי חולים, שדות תעופה ותעשיות ענק.",

        "footer-text": "© 2026 Diaa Hammud. כל הזכויות שמורות."
    }
};

// 1. نظام التنقل والتحكم الذكي بين الصفحات مع إغلاق الهيدر تلقائياً في الموبايل عند التنقل
...
// 2. محرك الترجمة الشامل لجميع الأقسام والكروت والاتجاهات الأساسية
...
// إعداد الحالة الأولية الافتراضية للغة عند تحميل الموقع
